...
<head>
    ...
    <style>
        ...
        .hero-title { font-weight: 900; font-size: 4rem; text-transform: uppercase; letter-spacing: -1px; text-shadow: 2px 2px 8px rgba(0,0,0,0.6); }
        ...
        .libro-reclamaciones { border: 1px solid #ccc; border-radius: 5px; padding: 5px; background: white; width: 150px; display: block; margin-top: 10px; }
        .social-icons a { font-size: 1.2rem; margin-right: 15px; color: #000; }
