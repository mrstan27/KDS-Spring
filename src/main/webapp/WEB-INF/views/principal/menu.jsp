...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/menu-estilo.css">
<link rel="stylesheet"
...
<body>
	...
	<div class="menu-grid">
		...
		<c:if
			test="${usuario.rol.nombreRol == 'Administrador' || usuario.rol.nombreRol == 'Compras' || usuario.rol.nombreRol == 'Almacenero'}">
			<a href="${pageContext.request.contextPath}/compras"
				class="card-menu">
				<div class="card-icon">
		...
		<c:if
			test="${usuario.rol.nombreRol == 'Administrador' || usuario.rol.nombreRol == 'Compras'}">
			<a href="${pageContext.request.contextPath}/compras/cotizaciones"
				class="card-menu">
				<div class="card-icon">
		...
		<c:if
			test="${usuario.rol.nombreRol == 'Administrador' || usuario.rol.nombreRol == 'Almacenero' || usuario.rol.nombreRol == 'Compras'}">
			...
			<a href="${pageContext.request.contextPath}/proveedor/lista"
				class="card-menu">
				<div class="card-icon">
		...
		<c:if
			test="${usuario.rol.nombreRol == 'Administrador' || usuario.rol.nombreRol == 'Almacenero'}">
		...
		<%-- SECCIÓN 5: VENTAS Y CLIENTES (Admin y Vendedor) --%>
		<c:if
			test="${usuario.rol.nombreRol == 'Administrador' || usuario.rol.nombreRol == 'Vendedor'}">
		...
		<c:if
			test="${usuario.rol.nombreRol == 'Administrador' || usuario.rol.nombreRol == 'Soporte'}">
